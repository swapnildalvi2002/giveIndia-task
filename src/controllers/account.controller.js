...
const getAccounts = catchAsync(async (req, res) => {
  const filter = pick(req.query, ['userId', 'accountType']);
...
const handleMoneyTransfer = catchAsync(async (req, res) => {
  const account = await accountService.handleMoneyTransfer(req.body.fromAccountId, req.body.toAccountId, req.body.amount);
  res.send(account);
});
